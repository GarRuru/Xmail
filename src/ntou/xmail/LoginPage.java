...
public class LoginPage {
	...
	private void initialize() {
		...
		setUIFont(new javax.swing.plaf.FontUIResource("�L�n������", Font.PLAIN, 14));
		try {
		...
		final String[] mailList = { "NTOU Mail", "PPT�����H" };
		...
		passwordField.addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent arg0) {
				JLabel capswarn = new JLabel("Caps Lock�w�g�ҥ�");
				capswarn.setFont(new Font("�L�n������", Font.PLAIN, 14));
		...
		label_1.setFont(new Font("�L�n������", Font.PLAIN, 14));
		label_1.setBounds(773, 132, 110, 23);
		frame.getContentPane().add(label_1);

		JLabel label_2 = new JLabel("\u4F7F\u7528\u8005\u5BC6\u78BC");
		label_2.setFont(new Font("�L�n������", Font.PLAIN, 14));
	...
	public void SendRequest() {
		...
		/*
		 * if(account == "" || password == "") {
		 * JOptionPane.showMessageDialog(null,"��줣�o����!","Error",JOptionPane.
	...
	private void PTTRequest() throws Exception
	{
		...
		try {
			...
			{
				JOptionPane.showMessageDialog(null, "�b���αK�X�����T", "Login Failed", JOptionPane.ERROR_MESSAGE);
			}
